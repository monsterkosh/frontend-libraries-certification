...
import '../styles/PomodoroTwoStyles.css';

class PomodoroClockTwo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      sessionLength: 1500,
  ...
  render() {
    return (
      <div className='App container-fluid'>
        ...
        <div>
          <p className='footer'>Thanks to @ArunMuralidharan</p>
        </div>
      </div>
    );
  }
...
export default PomodoroClockTwo;
