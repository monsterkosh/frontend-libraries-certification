  ...
  return (
    <div className='Calccontainer'>
      <div className='grid'>
        ...
        <div onClick={allClear} className='padButton AC red' id='clear'>
          AC
        </div>
        <div
          onClick={clear}
        ...
        <div
          onClick={() => display('*')}
          id='multiply'
          className='padButton times grey'
        >
          X
        </div>
        <div
        ...
        <div
          onClick={() => display('-')}
          id='subtract'
          className='padButton minus grey'
        >
          -
        </div>
        ...
        <div onClick={calculate} id='equals' className='padButton equa blue'>
          =
        </div>
